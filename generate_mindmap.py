                    ...
                    try {{
                        ...
                        if (isHtmlFormat && mapCanvas) {{
                            ...
                            if (canvasEl) {{
                                ...
                                // Find and fix page-container positioning - center it
                                const pageContainer = mapSvgContainer.querySelector('#page-container');
                                if (pageContainer) {{
                                    // Center the page-container within mapSvgContainer
            ...
            function updateMapTransform() {{
                ...
                requestAnimationFrame(function() {{
                    ...
                    if (isCanvasMode && mapCanvas) {{
                        ...
                        // Combine centering (-50%, -50%) with pan (mapX, mapY) and scale
                        mapSvgContainer.style.transform = `translate(calc(-50% + ${{mapX}}px), calc(-50% + ${{mapY}}px)) scale(${{mapScale}})`;
