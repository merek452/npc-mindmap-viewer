                                    ...
                                    setTimeout(function() {{
                                        ...
                                        if (typeof html2canvas !== 'undefined') {{
                                            html2canvas(pageContainer, {{
                                                ...
                                                // Set CSS dimensions for display (optional, but helps with initial visibility)
                                                // We'll let transforms handle the scaling, so we can set CSS to match or let it be auto
