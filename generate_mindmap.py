...
<head>
    ...
    <style>
        ...
        * {{
        ...
        body.map-tab-active .container {{
            padding: 0 !important;
            margin: 0 !important;
            max-width: 100% !important;
        }}
        
        body.map-tab-active #mapTab {{
            position: fixed;
            top: 0;
            left: 0;
            right: 0;
...
"""
        ...
        <div id="mapTab" class="tab-content" style="padding: 0; margin: 0;">
            <div style="padding: 8px 15px; background: rgba(0,0,0,0.3); border-bottom: 1px solid rgba(255,215,0,0.3);">
                ...
                <div style="background: rgba(0,0,0,0.3); border-radius: 6px; padding: 10px; border: 2px solid rgba(255,255,255,0.2); display: flex; gap: 10px; flex-wrap: wrap;">
                    <div style="flex: 1; min-width: 300px;">
                        ...
                        <div id="mapContainer" style="width: 100%; height: calc(100vh - 180px); overflow: hidden; background: rgba(0,0,0,0.2); position: relative; cursor: grab; touch-action: none; -webkit-user-select: none; user-select: none; contain: strict; isolation: isolate;">
